...
//        contentTable.add(timeButton).size(100, 100).padRight(5).left();
        ...
        Texture aDayAdvance = new Texture("assets/one_day.png");
        ImageButton aDayButton = new ImageButton(new TextureRegionDrawable(new TextureRegion(aDayAdvance)));
        ...
        buttonTable.add(timeButton).size(100, 100).padRight(5);
