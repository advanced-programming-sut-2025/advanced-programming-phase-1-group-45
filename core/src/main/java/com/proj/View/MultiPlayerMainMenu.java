...
public class MultiPlayerMainMenu implements Screen {
    private Stage stage;
    private final Table table;
    private final MultiPlayerMainMenuController controller;
    ...
    public MultiPlayerMainMenu(MultiPlayerMainMenuController controller, Skin skin) {
        ...
        this.loadGameButton = new TextButton("stay logged in", skin);
